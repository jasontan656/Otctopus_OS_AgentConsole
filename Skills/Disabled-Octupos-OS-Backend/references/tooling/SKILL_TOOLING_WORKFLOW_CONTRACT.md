# Disabled-Octupos-OS-Backend Tooling & Workflow Contract
...
- 模板索引统一从 `./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py template-index --json` 读取。
...
## 14. Example Commands
```bash
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py workflow-contract --json
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py stage-checklist --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py stage-doc-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py stage-command-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py stage-graph-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Disabled-Octupos-OS-Backend/scripts/Cli_Toolbox.py template-index --json
```
