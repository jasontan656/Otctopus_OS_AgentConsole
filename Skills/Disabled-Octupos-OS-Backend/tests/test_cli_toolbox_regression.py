...
RUNTIME_DOCS_ROOT = AI_PROJECTS_ROOT / "Codex_Skill_Runtime" / "Disabled-Octupos-OS-Backend" / "docs"
...
class TestCliToolboxRegressionTest:
    def test_workflow_contract_exposes_construction_plan_model(self) -> None:
        ...
        assert str(AI_PROJECTS_ROOT / "Octopus_OS" / "AGENTS.md") in payload["top_level_resident_docs"]
