...
RUNTIME_DOCS_ROOT = PRODUCT_ROOT / "Codex_Skill_Runtime" / "Disabled-Octupos-OS-Backend" / "docs"
...
class TestCliToolboxRegressionTest:
    def test_workflow_contract_exposes_construction_plan_model(self) -> None:
        ...
        assert str(PRODUCT_ROOT / "Octopus_OS" / "AGENTS.md") in payload["top_level_resident_docs"]
