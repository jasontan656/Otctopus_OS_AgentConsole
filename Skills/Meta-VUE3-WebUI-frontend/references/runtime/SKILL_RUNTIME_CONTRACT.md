...
topic: "Audit version of the staged runtime contract for Meta-VUE3-WebUI-frontend"
anchors:
...
## 合同目标
- 约束 `Meta-VUE3-WebUI-frontend` 只能以 staged skill 方式运行。
- 把前端规范、展厅设计、graph 展示与运行链拆成可切换的 stage。
