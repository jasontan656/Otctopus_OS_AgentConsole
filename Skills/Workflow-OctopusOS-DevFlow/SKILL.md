...
- Target runtime entry: `./.venv_backend_skills/bin/python Skills/Workflow-OctopusOS-DevFlow/scripts/Cli_Toolbox.py target-runtime-contract --target-root <target_root> --docs-root <docs_root> --json`
- Stage checklist entry: `./.venv_backend_skills/bin/python Skills/Workflow-OctopusOS-DevFlow/scripts/Cli_Toolbox.py stage-checklist --stage <mother_doc|construction_plan|implementation|acceptance> --target-root <target_root> --docs-root <docs_root> --json`
...
- 总体运行合同：
  ...
  - `scripts/Cli_Toolbox.py contract --json`
- 目标位置与阶段预检：
