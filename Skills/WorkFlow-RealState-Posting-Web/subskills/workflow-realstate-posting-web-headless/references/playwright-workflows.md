---
doc_id: workflow_realstate_posting_web.subskills_workflow_realstate_posting_web_headless_references_playwright_workflows
doc_type: topic_atom
...
Store artifacts under `<WorkspaceRoot>/ChangeLog/BrowserTests/consumers/<consumer_id>/runs/<run_id>/` and keep run evidence centralized.
