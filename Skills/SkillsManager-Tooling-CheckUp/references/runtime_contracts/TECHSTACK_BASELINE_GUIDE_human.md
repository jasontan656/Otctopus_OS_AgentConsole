...
```json
{
  ...
  "workflow": [
    ...
    "Check whether the mandatory baseline already covers that capability directly enough to remove the custom implementation.",
    "If the target logic is domain-specific or repo-specific beyond the baseline, keep it or narrow the rewrite scope."
  ],
  "rules": [
