---
name: "3-Octupos-OS-Backend"
description: "Project-description-driven backend skill: build a directory mother doc, derive a separate construction plan, implement against that plan, and deliver with real evidence."
---

# 3-Octupos-OS-Backend
