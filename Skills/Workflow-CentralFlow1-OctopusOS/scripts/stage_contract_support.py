...
def _runtime_cli_prefix(
    ...
    parts = [
        "./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py",
...
def stage_command_contract_payload(
    ...
    commands = {
        "mother_doc": {
            ...
            "gate_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-lint --path {mother_doc_root} --json",
            ],
            "optional_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-preflight --repo {codebase_root} --graph-runtime-root {graph_runtime_root} --allow-missing-index --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-mark-modified --path {mother_doc_root} --doc-ref <mother_doc_doc> --auto-from-git --json",
            ],
        ...
        "construction_plan": {
            ...
            "gate_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py construction-plan-lint --path {construction_plan_root} --json",
            ],
            "optional_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-preflight --repo {codebase_root} --graph-runtime-root {graph_runtime_root} --allow-missing-index --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-state-sync --path {mother_doc_root} --doc-ref <mother_doc_doc> --from-state modified --to-state planned --pack-ref <NN_slug> --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-mark-modified --path {mother_doc_root} --doc-ref <mother_doc_doc> --auto-from-git --json",
            ],
        ...
        "implementation": {
            ...
            "gate_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py construction-plan-lint --path {construction_plan_root} --require-execution-eligible --json",
            ],
            "optional_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-state-sync --path {mother_doc_root} --doc-ref <mother_doc_doc> --from-state planned --to-state developed --pack-ref <NN_slug> --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-mark-modified --path {mother_doc_root} --doc-ref <design_doc> --auto-from-git --json",
            ],
            "required_reuse_actions": [
        ...
        "acceptance": {
            ...
            "gate_commands": [
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py acceptance-lint --codebase-root {codebase_root} --target-root {target_root} --development-docs-root {docs_root} --docs-root {docs_root} --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-postflight --repo {codebase_root} --graph-runtime-root {graph_runtime_root} --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-state-sync --path {mother_doc_root} --doc-ref <mother_doc_doc> --from-state developed --to-state ref --pack-ref <NN_slug> --json",
                f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py mother-doc-archive --target {mother_doc_root} --json",
            ],
            "optional_commands": [],
...
def stage_graph_contract_payload(
    ...
    recommended_commands = {
        "mother_doc": [
            f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-preflight --repo {codebase_root} --graph-runtime-root {graph_root} --allow-missing-index --json",
        ],
        "construction_plan": [
            f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-preflight --repo {codebase_root} --graph-runtime-root {graph_root} --allow-missing-index --json",
        ],
        "implementation": [],
        "acceptance": [
            f"./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py graph-postflight --repo {codebase_root} --graph-runtime-root {graph_root} --json",
        ],
    }
    return {
        "stage": stage,
