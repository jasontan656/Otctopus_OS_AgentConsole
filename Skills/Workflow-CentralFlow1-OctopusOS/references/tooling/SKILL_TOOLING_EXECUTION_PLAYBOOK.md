---
doc_id: workflow_centralflow1_octopusos.references_tooling_skill_tooling_workflow_playbook
doc_type: topic_atom
topic: Workflow-CentralFlow1-OctopusOS Tooling & Workflow Contract
anchors:
- target: ../../SKILL.md
  relation: implements
  direction: upstream
...
# Workflow-CentralFlow1-OctopusOS Tooling & Workflow Contract
...
- 模板索引统一从 `./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py template-index --json` 读取。
...
## 14. Example Commands
```bash
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py workflow-contract --json
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py stage-checklist --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py stage-doc-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py stage-command-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py stage-graph-contract --stage construction_plan --json
./.venv_backend_skills/bin/python Skills/Workflow-CentralFlow1-OctopusOS/scripts/Cli_Toolbox.py template-index --json
```
