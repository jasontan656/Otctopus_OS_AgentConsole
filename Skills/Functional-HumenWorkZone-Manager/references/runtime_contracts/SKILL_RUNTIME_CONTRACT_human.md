...
```json
{
  ...
  "hard_constraints": [
    ...
    "Route open-source projects, backups, project analysis, books, temporary projects, company documents, and external research reports into their dedicated managed zones.",
