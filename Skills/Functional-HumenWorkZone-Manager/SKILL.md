...
- 当前先落成最小技能骨架，不预设复杂 workflow、自动化脚本或长期分类法。
...
4. 若未来新增目录约定、清单规则或工具入口，再进入对应下沉文档。
...
## 5. 执行入口
- 当前无专属 CLI。
- 当前入口即：`SKILL.md -> references/routing/TASK_ROUTING.md -> references/governance/SKILL_EXECUTION_RULES.md`。
