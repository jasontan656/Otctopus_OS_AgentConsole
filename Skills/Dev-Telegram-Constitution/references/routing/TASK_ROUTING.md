...
- 先判断当前问题属于哪一类，再读取一个主原子文档；不要一次性把四个原子文档全部展开。
...
- 适用：Python/TypeScript 框架、依赖组合、Bot API 路线推荐

## 分支三：交付、安全与消息流边界
- 先读 `../governance/SKILL_DOCSTRUCTURE_POLICY.md`
- 再读 `../governance/SKILL_EXECUTION_RULES.md`
- 再进入 `../telegram/TELEGRAM_DELIVERY_GUARDRAILS.md`
- 适用：webhook、getUpdates、callback、幂等、payload normalize、token 与日志边界

## 分支四：Mini App / WebApp 合同
- 先读 `../governance/SKILL_DOCSTRUCTURE_POLICY.md`
- 再读 `../governance/SKILL_EXECUTION_RULES.md`
- 再进入 `../telegram/TELEGRAM_MINI_APP_CONTRACT.md`
- 适用：Mini App 容器边界、init data 验证、前后端协同、Bot 与 Mini App 分工
