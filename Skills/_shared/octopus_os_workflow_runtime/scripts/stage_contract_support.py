...
def stage_command_contract_payload(
    ...
    commands = {
        "mother_doc": {
            ...
            "gate_commands": [
                cli_command("mother-doc-lint", "--path", mother_doc_root, "--json"),
            ],
            "optional_commands": [
                cli_command(
                    "graph-preflight",
                ...
                cli_command("mother-doc-audit", "--path", mother_doc_root, "--json"),
                cli_command("mother-doc-refresh-root-index", "--path", mother_doc_root, "--json"),
                cli_command("mother-doc-mark-modified", "--path", mother_doc_root, "--doc-ref", "<mother_doc_doc>", "--auto-from-git", "--json"),
                cli_command("mother-doc-sync-client-copy", "--source", mother_doc_root, "--mirror", runtime["client_mother_doc_root"], "--json"),
            ],
            "required_iteration_actions": [
                ...
                "derive the intended semantic move from the live request and current mother_doc tree before invoking governance-only helpers",
                "treat resident overview/index/common-rule docs as the stable spine of the doc system instead of letting implementation details flood back into them",
                ...
                "read graph context only after the requirement-source intake so code reality can correct stale assumptions without becoming the requirement source",
                ...
                "when a deeper anchor doc is needed, wait for the user to specify that next topic explicitly before creating the new anchor node",
                "invoke mother-doc-audit only when the current tree is overloaded, ambiguous, drifting, or undergoing a substantial structural rewrite",
                "if audit reveals reusable split guidance, prefer it over ad hoc branching, but do not let it override the live requirement source",
                ...
                "after topic-level writeback changes the global shape, update the affected overview/index/entry-map docs in the same turn",
                ...
                "after refreshing the root index, run mother-doc-sync-client-copy so the viewer-side Client_Applications/mother_doc mirror is overwritten from the Development_Docs source tree",
                "rerun mother-doc-audit only when folder structure changed materially or when governance debt is still suspected after writeback",
            ],
        },
        "construction_plan": {
            "entry_commands": [
            ...
            "gate_commands": [
                cli_command("construction-plan-lint", "--path", construction_plan_root, "--json"),
            ],
            "optional_commands": [
                cli_command(
                    "graph-preflight",
        ...
        "implementation": {
            ...
            "gate_commands": [
                cli_command("construction-plan-lint", "--path", construction_plan_root, "--require-execution-eligible", "--json"),
            ],
            "optional_commands": [
                cli_command(
                    "mother-doc-state-sync",
                ...
                cli_command("mother-doc-mark-modified", "--path", mother_doc_root, "--doc-ref", "<design_doc>", "--auto-from-git", "--json"),
            ],
            "required_reuse_actions": [
        ...
        "acceptance": {
            ...
            "gate_commands": [
                ...
                cli_command("graph-postflight", "--repo", codebase_root, "--graph-runtime-root", graph_runtime_root, "--json"),
                cli_command(
                    "mother-doc-state-sync",
                    "--path",
                    mother_doc_root,
                ...
                cli_command("mother-doc-archive", "--target", mother_doc_root, "--json"),
            ],
            "optional_commands": [],
...
def stage_graph_contract_payload(
    ...
    recommended_commands = {
        "mother_doc": [
            cli_command("graph-preflight", "--repo", codebase_root, "--graph-runtime-root", graph_root, "--allow-missing-index", "--json"),
        ],
        "construction_plan": [
            cli_command("graph-preflight", "--repo", codebase_root, "--graph-runtime-root", graph_root, "--allow-missing-index", "--json"),
        ],
        "implementation": [],
        "acceptance": [
            cli_command("graph-postflight", "--repo", codebase_root, "--graph-runtime-root", graph_root, "--json"),
        ],
    }
    return {
        "stage": stage,
