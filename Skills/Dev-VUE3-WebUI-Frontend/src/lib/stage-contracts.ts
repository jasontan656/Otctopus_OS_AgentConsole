  ...
  motion_component_architecture: {
    checklist: {
      ...
      stage_docs: [
        ...
        'frontend_dev_contracts/code_architecture/00_CODE_ARCHITECTURE_INDEX.md',
    ...
    docContract: {
      ...
      doc_boundary: [
        ...
        'references/stages/30_STAGE_MOTION_COMPONENT_ARCHITECTURE.md',
        'frontend_dev_contracts/design_system/00_DESIGN_SYSTEM_INDEX.md',
        'frontend_dev_contracts/design_system/foundations/10_DESIGN_TOKEN_MODEL.md',
        'frontend_dev_contracts/component_system/00_COMPONENT_SYSTEM_INDEX.md',
        'frontend_dev_contracts/component_system/packaging/10_COMPONENT_PACKAGE_SHAPE.md',
        'frontend_dev_contracts/code_architecture/00_CODE_ARCHITECTURE_INDEX.md',
        'frontend_dev_contracts/code_architecture/packages/10_COMPONENT_FOLDER_TEMPLATE.md',
        'frontend_dev_contracts/layers/10_LAYER_TAXONOMY.md',
        'frontend_dev_contracts/layers/20_LAYER_NODE_MAPPING.md',
        'frontend_dev_contracts/positioning/UI_FILE_ORGANIZATION.md',
        'frontend_dev_contracts/containers/model/10_CONTAINER_ROLE_TAXONOMY.md',
