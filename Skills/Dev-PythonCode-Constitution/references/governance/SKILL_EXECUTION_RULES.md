...
- 若任务内容包含 Python 相关编辑，且需要在回合末执行结构/边界校验，应运行 `./.venv_backend_skills/bin/python Skills/Dev-PythonCode-Constitution/scripts/run_python_code_lints.py --target <target_root>`。
