...
- 当前工具面只服务 Python 相关 lint。
- 当前 lint 边界已收紧为“Python 文件 + 已确认的 Python 资产”，并移除了泛目录结构治理职责。
- 当前 lint 已扩展为“结构治理 + runtime safety”双轴：除胖文件与资产边界外，还包含 typing、data boundary、concurrency、import side effect、exception、subprocess、HTTP timeout、logging 八类 Python 工程安全 gate。
...
- 2026-03-12 迁移：统一承接 Python 专属 lint 与胖代码治理职责。
