...
def build_parser() -> argparse.ArgumentParser:
    ...
    init_parser.set_defaults(func=_command_init_store)
    ...
    bind_parser.set_defaults(func=_command_bind_task)
    ...
    compile_parser.set_defaults(func=_command_compile_active_memory)
    ...
    upsert_user_parser.set_defaults(func=_command_upsert_user_memory)
    ...
    upsert_task_parser.set_defaults(func=_command_upsert_task_memory)
    ...
    delta_parser.set_defaults(func=_command_append_turn_delta)
    ...
    validate_parser.set_defaults(func=_command_validate_store)
    ...
    recall_parser.set_defaults(func=_command_recall_memory)
    ...
    search_parser.set_defaults(func=_command_search_memory)
    return parser
