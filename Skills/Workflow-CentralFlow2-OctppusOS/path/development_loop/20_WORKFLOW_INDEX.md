...
- key: mother_doc
  ...
  hop: branch
  reason: mother_doc 是主闭环的第一个阶段，且自身是复合子 workflow。
...
## 当前入口的复合阶段
1. [mother_doc]：`steps/mother_doc/00_MOTHER_DOC_ENTRY.md`
2. [construction_plan]：`steps/construction_plan/00_CONSTRUCTION_PLAN_ENTRY.md`
3. [implementation]：`steps/implementation/00_IMPLEMENTATION_ENTRY.md`
4. [acceptance]：`steps/acceptance/00_ACCEPTANCE_ENTRY.md`
