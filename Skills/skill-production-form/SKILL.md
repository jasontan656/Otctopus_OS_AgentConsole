...
- 本技能的 active runtime 日志必须落盘到 `/home/jasontan656/AI_Projects/Codex_Skill_Runtime/skill-production-form`；默认结果根为 `/home/jasontan656/AI_Projects/Codex_Skills_Result/skill-production-form`。
...
- 运行时落盘约束：
  - 默认日志落点：`/home/jasontan656/AI_Projects/Codex_Skill_Runtime/skill-production-form/ITERATION_LOG.md`
  - 默认结果根：`/home/jasontan656/AI_Projects/Codex_Skills_Result/skill-production-form/`
