...
## Permission Boundary Markers

- action: login, save authentication state, restore authenticated browsing state
- actor_id: current local Codex operator
- authz_result: require explicit user authorization before storing or reusing sensitive production credentials
- deny_code: no_user_auth_for_sensitive_auth_flow
- policy_version: meta-agent-browser-authentication-v1
- role: local automation assistant
- scope: local auth state files, browser cookies, browser storage, interactive login flows
