...
- 当前 lint 已扩展为“结构治理 + runtime safety”双轴：除胖文件与资产边界外，还包含 typing、data boundary、concurrency、io boundary、time/random、import side effect、exception、subprocess、HTTP timeout、logging 十类 Python 工程安全 gate。
