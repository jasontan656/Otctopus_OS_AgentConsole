...
- 当前 gate 组合包含：结构治理、Python 资产边界、typing、exception、subprocess、HTTP timeout、logging 七类 Python 专属安全规则。
...
- runtime safety：当前新增 `typing_governance_gate`、`exception_governance_gate`、`subprocess_safety_gate`、`http_timeout_gate`、`logging_boundary_gate`
