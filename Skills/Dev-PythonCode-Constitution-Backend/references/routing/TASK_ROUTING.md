...
- 若任务明确落到 typing、data boundary、concurrency、exception、logging、subprocess、HTTP timeout 或 Python 工程安全边界，再读 `../python_rules/PYTHON_RUNTIME_SAFETY_CONSTITUTION.md`。
...
- 若 lint 涉及 typing、data boundary、concurrency、exception、logging、subprocess、HTTP timeout 安全边界，也要同时读 `../python_rules/PYTHON_RUNTIME_SAFETY_CONSTITUTION.md`。
