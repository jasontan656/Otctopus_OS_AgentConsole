...
5. 若任务涉及 typing、data boundary、concurrency、exception、logging、subprocess、HTTP timeout 或 Python 工程安全边界，再读取 `references/python_rules/PYTHON_RUNTIME_SAFETY_CONSTITUTION.md`。
