...
- `render_docx` | domain:`skill_tool` | owner:`Word-docs`
  - entrypoint: `scripts/render_docx.py`
  - quick_command: `python3 scripts/render_docx.py --help`
  - usage_summary: Governed tool contract for render_docx; keep script/docs/ledger synchronized during self-evolution.
- `tg_governance_audit_log` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_full_gate_lint` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_layer_schema_lint` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_linear_composite` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_linear_flow` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_linear_layers` | domain:`governance_toolbox` | owner:`Word-docs`
...
- `tg_mstg_l0_l13_linear_lint` | domain:`governance_toolbox` | owner:`Word-docs`
  - entrypoint: `tooling_governance/default/scripts/mstg_l0_l13_linear_lint.py`
  - quick_command: `python3 tooling_governance/default/scripts/mstg_l0_l13_linear_lint.py --help`
  - usage_summary: Governed tool contract for tg_mstg_l0_l13_linear_lint; keep script/docs/ledger synchronized during self-evolution.

## 快速使用入口（AI 直接执行）
- `render_docx` -> `python3 scripts/render_docx.py --help`
...
- `tg_mstg_l0_l13_linear_writeback` -> `python3 tooling_governance/default/scripts/mstg_l0_l13_linear_writeback.py --help`
