...
## Document Status
doc_path: Notification_Service/features/README.md
...
feature document scope for the current container; choose the affected requirement or unresolved question slice below.

- Use `features.md` in the same directory as the scope-entity document for the current directory itself.
