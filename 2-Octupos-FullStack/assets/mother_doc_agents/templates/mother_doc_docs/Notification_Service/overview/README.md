...
## Document Status
doc_path: Notification_Service/overview/README.md
...
human-readable overview scope for the current container; start here when you need top-level comprehension.

- Use `overview.md` in the same directory as the scope-entity document for the current directory itself.
