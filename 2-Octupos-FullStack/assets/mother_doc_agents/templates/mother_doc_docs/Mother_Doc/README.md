...
- `project_baseline/` inside this directory is the always-load project baseline before container-specific scope selection.
...
- `project_baseline/` carries the project-wide operating model, current delivery focus, impact-pruning rule, and dynamic document growth guidance.
