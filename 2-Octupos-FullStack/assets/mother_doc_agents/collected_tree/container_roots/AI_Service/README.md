...
<!-- replace_me: 这里写 `AI_Service` 当前容器项目的浓缩总结，内容应跟随容器代码、文档与 evidence 的实际状态更新。 -->

## 1. 容器定位
- 当前文件是 `AI_Service` 容器根的 AI-facing README。
- 对应容器说明：AI domain container。
...
## 3. 对应文档入口
- `../Mother_Doc/docs/AI_Service/`: 当前容器对应的 authored-doc 根。
- `../Mother_Doc/docs/AI_Service/README.md`: 当前容器文档域的浓缩总结。
