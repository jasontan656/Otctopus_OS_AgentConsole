...
## Document Status
doc_path: Notification_Service/common/code_abstractions/README.md
...
code abstraction root for the current container; choose one code-facing abstract domain below.

- Use `code_abstractions.md` in the same directory as the scope-entity document for the current directory itself.
