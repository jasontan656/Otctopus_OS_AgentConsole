...
## Document Status
doc_path: Notification_Service/common/dev_canon/README.md
...
recovered development canon scope for the current container.

- Use `dev_canon.md` in the same directory as the scope-entity document for the current directory itself.
