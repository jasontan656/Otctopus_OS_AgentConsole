...
## Document Status
doc_path: Notification_Service/common/writing_guides/README.md
...
authored-doc update guidance scope for the current container.

- Use `writing_guides.md` in the same directory as the scope-entity document for the current directory itself.
