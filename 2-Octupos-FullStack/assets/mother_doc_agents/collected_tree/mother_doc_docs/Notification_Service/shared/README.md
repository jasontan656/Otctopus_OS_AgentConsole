...
## Document Status
doc_path: Notification_Service/shared/README.md
...
shared integration scope for the current container; choose APIs, events, contracts, or cross-container dependencies below.

- Use `shared.md` in the same directory as the scope-entity document for the current directory itself.
