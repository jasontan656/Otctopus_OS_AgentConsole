...
- `python3 /home/jasontan656/AI_Projects/Codex_Skills_Mirror/2-Octupos-FullStack/scripts/Cli_Toolbox.py mother-doc-agents-target-contract --relative-path "mother_doc_docs/Account_Service/common/code_abstractions/architecture" --file-kind agents --json`
