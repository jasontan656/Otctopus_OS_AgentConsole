...
6. `SKILL.md` 门面只描述如何使用本技能，以及文档撰写、代码落盘、evidence 回填规范。
7. 实际对 UI 的设计、event 设计、后端支持与其他实现细节，必须落入本技能产出的开发运维文档中，不得堆回 `SKILL.md` 门面。
8. 技能写文档是一回事；按照文档开发出来的内容是另一回事，二者边界必须清楚。
