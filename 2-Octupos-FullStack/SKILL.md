...
## 2. 可用工具
- `SKILL.md` 门面只描述本技能如何工作，也就是本技能的自有规则：如何使用本技能，以及文档撰写、代码落盘、evidence 回填的运行规范。
- 实际对 UI 的设计、event 设计、后端支持与其他实现细节，不属于本技能自有规则；它们属于本技能产出的被撰写规则，必须落入开发运维文档中。
...
- 本技能自有规则只约束“如何写文档与如何落盘”；被撰写规则才约束“文档里定义出的 UI、event、后端、数据库与运维实现”。
