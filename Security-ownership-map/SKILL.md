...
Install with the shared skills runtime contract:

```bash
python3 ~/.codex/skills/Meta-skills-tooling-governance/scripts/shared_tooling_runtime_contract.py bootstrap
```

This installs `networkx` and other governed skill dependencies from
`~/.codex/skills/.tooling_runtime/tooling_requirements.lock` into
`~/.codex/skills/.tooling_runtime/.venv`.
