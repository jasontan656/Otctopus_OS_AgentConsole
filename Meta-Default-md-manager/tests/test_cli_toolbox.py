...
def root_payload() -> dict:
    return {
        ...
        "default_meta_skill_order": [
            ...
            "$skill-mirror-to-codex (all skill edit must happen first in Codex_Skills_Mirror folder and then use the skill to push/install to codex installation folder )",
